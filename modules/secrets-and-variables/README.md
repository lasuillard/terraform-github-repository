...
| <a name="input_codespaces_secrets"></a> [codespaces\_secrets](#input\_codespaces\_secrets) | Codespaces secrets for this repository. | <pre>list(object({<br>    secret_name     = string<br>    encrypted_value = optional(string)<br>    plaintext_value = optional(string)<br>  }))</pre> | `[]` | no |
| <a name="input_create"></a> [create](#input\_create) | Whether to create this module or not. | `bool` | `true` | no |
| <a name="input_dependabot_secrets"></a> [dependabot\_secrets](#input\_dependabot\_secrets) | Dependabot secrets for this repository. | <pre>list(object({<br>    secret_name     = string<br>    encrypted_value = optional(string)<br>    plaintext_value = optional(string)<br>  }))</pre> | `[]` | no |
