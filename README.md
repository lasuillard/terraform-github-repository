...
| <a name="input_autolink_references"></a> [autolink\_references](#input\_autolink\_references) | Autolink references. | `list(map(string))` | `[]` | no |
| <a name="input_branch_protections"></a> [branch\_protections](#input\_branch\_protections) | Branch protection rules. | `list(map(any))` | `[]` | no |
| <a name="input_branches"></a> [branches](#input\_branches) | List of branches to create. | `list(map(string))` | `[]` | no |
...
| <a name="input_collaborators"></a> [collaborators](#input\_collaborators) | List of collaboratos. | `list(map(any))` | `[]` | no |
...
| <a name="input_rulesets"></a> [rulesets](#input\_rulesets) | Repository rulesets. | `list(map(any))` | `[]` | no |
...
| <a name="input_tag_protections"></a> [tag\_protections](#input\_tag\_protections) | Tag protection rules. | `list(map(string))` | `[]` | no |
